...
import LO_MANAGER_ABI from 'abis/limit-order-manager.json'
...
export function useLOManager(): Contract | null {
  return useContract<LimitOrderManager>(LO_MANAGER_ADDRESSES, LO_MANAGER_ABI, true)
}
